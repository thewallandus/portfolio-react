...
export default ({
  ...
  description = "What you'll need to do to be able to afford me.",
  plans = null,
  ...
  const defaultPlans = [
    {
      name: "Consult Me",
      durationPrices: ["$30", "$300"],
      mainFeature: "Fix My Process Plan",
      features: ["1-1 calls", "Copywriting Checklist", "Weekly Check-Ins"]
    },
    {
      name: "Hire Me",
      durationPrices: ["$50", "$5000"],
      mainFeature: "For Early Stage Startups",
      features: ["60 Templates", "30 LinkedIn Posts", "1-1 calls"],
      featured: true
    }
  ];
